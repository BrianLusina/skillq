...
func NewConsumer[T rabbitmq.Delivery](client amqp.AmqpClient, log logger.Logger, opts ...Option) (messaging.Consumer, error) {
...
func (c *AmqpConsumer) Consume(ctx context.Context, queue string) error {
...
func (c *AmqpConsumer) StartConsumer(fn messaging.Worker[any]) error {
...
func (c *AmqpConsumer) AddHandler(ctx context.Context, task string, handler func(payload []byte) error) {

}

// CreateChannel creates a rabbit MQ channel
func (c *AmqpConsumer) CreateChannel() (*rabbitmq.Channel, error) {
